/**
 * Seed corpus: 5 locked anchors + 14 spread essays.
 *
 * Anchors are frozen calibration nodes (spec Part 5) — the fixed stars the
 * ladder is measured against. The 4.5 anchor (score 45) is the linchpin: a
 * genuinely well-written, sincere, moving essay that reveals nothing
 * distinctive. It teaches the boundary the judge most wants to violate.
 *
 * Seeds are deliberately spread across the range — including weak and
 * mediocre essays — because published essays are survivor-biased toward the
 * top decile. Synthetic-but-spread beats real-but-all-excellent.
 *
 * score is on the 0–100 display scale; elo = 1000 + score*10.
 */
...
export const SEED_CORPUS: SeedEssay[] = [
  // ==========================================================================
  // ANCHORS (locked)
  // ==========================================================================
  {
    label: "anchor-10-self-damaging",
    source: "anchor",
    score: 10,
    prose: 42,
    content: `People always ask me how I manage to be good at so many things. Honestly, I don't have a great answer. Some people are just built to lead, and I've known since middle school that I'm one of them.
...
My guidance counselor told me to write this essay about a time I failed. I considered it, but the truth is my failures have all been other people's failures that I couldn't fully compensate for. The generator of my success is internal, and it hasn't stopped running yet. Whichever college is lucky enough to get me will find that out quickly.`,
  },
  {
    label: "anchor-25-competent-weak",
    source: "anchor",
    score: 25,
    prose: 40,
    content: `The whistle blew and I went down hard. As I lay on the turf clutching my knee, I didn't know it yet, but my life was about to change forever.
...
I don't know yet what I will study, or what I will become. But I know what I carry: the patience to practice something until my hands remember it, and the understanding that love, most of the time, looks like showing up on Sunday and getting the rice slightly wrong.`,
  },
  {
    label: "anchor-60-distinctive-uneven",
    source: "anchor",
    score: 60,
    prose: 50,
    content: `I keep a spreadsheet of every word I've ever mispronounced in public. It has 217 entries. Column D is "witnesses."
...
Two hundred and seventeen rows. Every single one says no.`,
  },
  {
    label: "anchor-80-standout",
    source: "anchor",
    score: 80,
    prose: 60,
    content: `My father and I have argued about the same intersection for six years.
...
I want to spend my life counting the things people carry but can't prove. Not because the committees will listen. Because someone at the kitchen table is waiting to be checked.`,
  },

  // ==========================================================================
  // SEEDS (mobile until frozen)
  // ==========================================================================
  {
    label: "seed-15-generic-mission",
    source: "seed",
    score: 15,
    prose: 33,
    content: `Last summer I went on a mission trip to Guatemala that changed my life. Before the trip, I took many things for granted, like clean water, my house, and my education. Seeing how the people there lived opened my eyes to how lucky I am.
...
In college I want to continue giving back to the community and maybe study abroad to experience more cultures. The world is a big place and I have learned that we all have something to learn from each other. Guatemala will always have a special place in my heart, and I will never forget the people who taught me that happiness doesn't come from what you have, but from what you give.`,
  ...
  {
    label: "seed-20-resume-recital",
    source: "seed",
    score: 20,
    prose: 36,
    content: `Throughout my four years of high school, I have challenged myself in many ways that have prepared me for college and beyond.
...
I believe my combination of academic rigor, leadership experience, and extracurricular commitment makes me ready for the challenges of a top university. I am excited to bring my work ethic, curiosity, and dedication to a campus community, and to keep growing into the leader I know I can become.`,
  },
  {
    label: "seed-28-divorce-safe",
    source: "seed",
    score: 28,
    prose: 44,
    content: `The day my parents told me they were getting divorced, I was twelve years old and had just come home from a friend's birthday party. I remember the cake still sitting in my stomach while they sat me down in the living room and used calm voices that scared me more than yelling would have.
...
I wouldn't wish those years on anyone, but I wouldn't trade what they gave me either. I am more empathetic, more adaptable, and more honest about my feelings than I would have been otherwise. Whatever roommate I end up with in college, they're getting someone who knows how to share a space, listen at midnight, and make a decent frozen pizza.`,
  },
  {
    label: "seed-32-robotics-standard",
    source: "seed",
    score: 32,
    prose: 41,
    content: `Three weeks before the regional robotics competition, our robot could not pick up a single ball. The intake mechanism we had spent two months designing jammed every third attempt, and morale in the workshop was at an all-time low.
...
I plan to study mechanical engineering, and I know I will make more wrong calls — engineering is wrong calls, corrected. What robotics gave me is the reflex to say so out loud, on Tuesday, with nineteen days left, while there is still time to rebuild.`,
  },
  {
    label: "seed-36-moving-schools",
    source: "seed",
    score: 36,
    prose: 45,
    content: `I have attended four schools in three states, and at every one of them I have been "the new kid" — a title that comes with an invisible clipboard. People decide things about you in the first week, and you spend the rest of the year living inside their decisions.
...
When I get to college, everyone will be the new kid at the same time. I already know what I'll be doing that first month. My roommate should be warned: I will be saying yes to almost everything, and I will probably drag them with me.`,
  },
  {
    label: "seed-40-grocery-job",
    source: "seed",
    score: 40,
    prose: 46,
    content: `Register four at Hartley's Market has a wobble. You have to shim the left leg with a folded receipt or the whole station rocks every time you scan a can. I know this because I have spent eleven hundred hours behind it.
...
I don't romanticize the job. My feet hurt and the pay is what it is. But I have a education you can't get in a classroom: eleven hundred hours of watching what people carry, and learning which small things I can do about it.`,
  },
  {
    label: "seed-42-debate-listening",
    source: "seed",
    score: 42,
    prose: 48,
    content: `I joined debate to learn how to talk. I stayed because it taught me how to lose.
...
I used to think debate was the art of being unanswerable. It is closer to the opposite: the discipline of being answerable — of stating the other side so fairly that your disagreement, when it comes, actually lands on something real. I want to study law, where I am told listening is a competitive advantage. It shouldn't be. But I'll take it.`,
  ...
  {
    label: "seed-45-piano-competent",
    source: "seed",
    score: 45,
    prose: 52,
    content: `The metronome on my piano is older than I am. It belonged to my first teacher, Mrs. Albrecht, who gave it to me when she retired, and its tick has been the background rhythm of my life for eleven years.
...
I will never be a concert pianist, and I have made peace with the metronome's real lesson: talent sets the ceiling, but tempo sets the floor, and you can live a whole life raising the floor. Tick by tick, forty beats a minute, I intend to keep doing exactly that.`,
  },
  {
    label: "seed-48-birdwatching-dad",
    source: "seed",
    score: 48,
    prose: 50,
    content: `My father doesn't say "I love you." He says "merlin, two o'clock, on the wire."
...
Merlin, two o'clock, on the wire. I know what it means. I say it back.`,
  },
  {
    label: "seed-52-translation-app",
    source: "seed",
    score: 52,
    prose: 47,
    content: `The app I built has fourteen users, and twelve of them are named Nguyen.
...
Forty towels, ninety minutes, the real fear. I'm bringing all three to college.`,
  },
  {
    label: "seed-68-pothole-archive",
    source: "seed",
    score: 68,
    prose: 55,
    content: `I photograph potholes. Not artistically — forensically. Every pothole on the six streets around my house, dated, measured with a tape measure my mother thinks she lost, uploaded to a database I named, with the unearned confidence of a fifteen-year-old, the Municipal Neglect Archive.
...
Three years. I'll keep it as long as the word RESOLVED keeps lying. What I want to study is really just this: who checks the record against the road, and what happens when nobody does.`,
  },
  // --- Expansion: density through the middle band, where most applicant
  // essays land and where the matchmaker clusters late in a tournament. ---
  {
    label: "seed-18-sports-captain-cliche",
    source: "seed",
    score: 18,
    prose: 35,
    content: `Being named captain of the varsity basketball team my senior year was one of the proudest moments of my life. It taught me that leadership is not about being the best player, but about lifting up everyone around you.
...
I am not the same person I was before. I am more grateful, more aware of how quickly things can change, and more determined to make the most of the time I have. My grandfather would have wanted that. Every time I accomplish something, I imagine telling him about it, and I can hear exactly what he would say.`,
  },
  {
    label: "seed-30-first-gen-pressure",
    source: "seed",
    score: 30,
    prose: 46,
    content: `My parents did not go to college, and for most of my life that fact sat in the middle of our kitchen table like a place setting for someone who never showed up.
...
I still cannot ask my parents for help with homework. But I can tell them what a FAFSA is, in Spanish, at the kitchen table. That is a start.`,
  },
  {
    label: "seed-34-orchestra-second-chair",
    source: "seed",
    score: 34,
    prose: 47,
    content: `I have been second chair viola for four years, and I have made peace with the fact that I will never be first.
...
Priya is going to conservatory. I am not. I am going to study something where the view from second chair is worth having.`,
  },
  {
    label: "seed-38-summer-camp-counselor",
    source: "seed",
    score: 38,
    prose: 48,
    content: `The hardest camper I ever had was a nine-year-old named Elliot who refused to swim.
...
I have thought about that summer more than almost anything else in high school. My instinct — everyone's instinct — was to solve the visible problem. The visible problem was almost never the real one. I want to work with kids, and the first thing I will bring is the willingness to sit on the dock for six days.`,
  },
  {
    label: "seed-41-coding-bootcamp-failure",
    source: "seed",
    score: 41,
    prose: 45,
    content: `My app has been rejected from the App Store four times. I want to tell you about the fourth one.
...
I used to think being a good engineer meant being able to build anything. I am starting to think it means being willing to build the boring thing that someone actually needs. The habit tracker was better code. The shift board is better work.`,
  },
  {
    label: "seed-44-model-un-competent",
    source: "seed",
    score: 44,
    prose: 55,
    content: `In Model UN, I represented Belarus twice, and both times I lost the same argument in the same way.
...
But the proposals are better, and I would rather be the person who wrote a workable one than the person who was clever about why it could not be done.`,
  },
  {
    label: "seed-47-diner-night-shift",
    source: "seed",
    score: 47,
    prose: 49,
    content: `The Skyline Diner serves about four hundred cups of coffee between eleven at night and six in the morning, and I have poured most of them for the last two summers.
...
Nobody in my school remembers that project. It is the only thing I have ever made that a professional wanted.`,
  },
  {
    label: "seed-53-church-organ-repair",
    source: "seed",
    score: 53,
    prose: 52,
    content: `There are 1,412 pipes in the organ at St. Bartholomew's and I have had my hands inside roughly six hundred of them.
...
I am not sure whether this is a loss. Something opaque became transparent to me, and now I cannot go back. I want to spend my life doing that to more things — taking the beautiful thing apart until it becomes a mechanism, and finding out that the mechanism is beautiful too.`,
  },
  {
    label: "seed-58-hospice-volunteer",
    source: "seed",
    score: 58,
    prose: 54,
    content: `I have been present for four deaths, and in three of them nobody was talking.
...
I am going into medicine, and I already know the thing I will be worst at is the thing I am practicing now: staying in the room when there is nothing to do in it.`,
  },
  {
    label: "seed-65-bus-route-map",
    source: "seed",
    score: 65,
    prose: 53,
    content: `I have ridden the 47 bus 1,900 times and I have never once been on it for transportation.
...
They cut it anyway. I want to study transportation policy, and it is not because I think I will win those meetings. It is because I have noticed that the people who show up to them have almost never been on the bus.`,
  },
  {
    label: "seed-71-mothers-accent",
    source: "seed",
    score: 71,
    prose: 57,
    content: `When I was twelve I corrected my mother's English in front of a cashier, and she did not speak to me for the rest of the day.
...
That is not an apology. I know that. It is a tax I have decided to pay for a long time.`,
  },

  {
    label: "seed-75-nail-salon-ledger",
    source: "seed",
    score: 75,
    prose: 58,
    content: `My mother's appointment book is written in three alphabets, and I am the only person alive who can read all of it.
...
People ask what I want to do, and I say something about economics, which is true but incomplete. What I actually want is to spend my life the way that book spends its ink: precise in public, generous in code, keeping accounts the guards can't read.`,
  },
];
